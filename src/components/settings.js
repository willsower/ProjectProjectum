        ...
        <div className="grow p-5 pl-8 overflow-auto">
          ...
          {accountSettingsClicked && (
            <>
              ...
              <p className = "settingsHeader">Prevent cards from overlapping</p>
              <p className = "settingsDesc">Automatically move nearby cards when editing causes a card to grow</p>

              <p className = "settingsHeader">Enable 3D effects when dragging cards</p>
              <p className = "settingsDesc">Disabling will improve performance on older machines</p>

              <p className = "settingsHeader">Show grid by default</p>
              <p className = "settingsDesc">Right click on the background to change this setting on an individual board</p>

              <p className = "settingsHeader">Show template suggestions</p>
              <p className = "settingsDesc">Recommended templates will be shown every time you create a board</p>

              <p className = "settingsHeader">Show "helpers" on cards</p>
              <p className = "settingsDesc">When a note is duplicated, ask “Keep this copy in sync?”</p>
              <p className = "settingsDesc">When a note becomes too long, ask “Convert to a document?”</p>
              <p className = "settingsDesc">When you create multiple to-do items, ask “Add a title to this list?”</p>
              <p className = "settingsDesc">When items are checked off a to-do list, ask “Delete completed tasks?”</p>

              <p className = "settingsHeader">Enable ink effect when drawing</p>
              <p className = "settingsDesc">Speed and pressure will affect the line thickness when you draw</p>
            </>
          )}
